...
var ManyReddit_1 = __webpack_require__(11);
...
ReactDOM.render(
// <TodoList {...todoList} />,
React.createElement(ManyReddit_1.ManyReddit, null), document.getElementById("app-root"));
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(1);
var subreddit_1 = __webpack_require__(12);
var style = __webpack_require__(32);
var ManyReddit = /** @class */ (function (_super) {
    __extends(ManyReddit, _super);
    function ManyReddit() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ManyReddit.prototype.render = function () {
        var subreddits = ["news", "politics", "tacos", "funny"];
        var reddits = subreddits.map(function (s, i) {
            return React.createElement("div", null,
                React.createElement("h1", null, s),
                React.createElement(subreddit_1.SubReddit, { key: i, subreddit: s }));
        });
        return React.createElement("div", { className: style.wrapper }, reddits);
    };
    return ManyReddit;
}(React.Component));
exports.ManyReddit = ManyReddit;
...
var SubReddit = /** @class */ (function (_super) {
    __extends(SubReddit, _super);
    function SubReddit(props) {
        var _this = _super.call(this, props) || this;
        _this.state = { complete: false, posts: [] };
        return _this;
    }
    SubReddit.prototype.componentDidMount = function () {
        var _this = this;
        axios_1.default.get("http://www.reddit.com/r/" + this.props.subreddit + ".json")
            .then(function (res) {
            ...
            _this.setState({ complete: true, posts: posts });
            console.log(posts);
        });
    };
    SubReddit.prototype.render = function () {
        var posts = this.state.posts.map(function (post, i) {
            return React.createElement("div", { className: "post", key: i },
...
module.exports = {"wrapper":"wrapper___3gIwK"};
